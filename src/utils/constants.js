/**
 * @file Contém constantes usadas em todo o script.
 */

/**
 * A base de caracteres usada para codificar o ID do autor do template.
 * @type {string}
 */
export const ENCODING_BASE = '!#$%&\'()*+,-./0123456789:;<=>?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[]^_`abcdefghijklmnopqrstuvwxyz{|}~';

/**
 * A paleta de cores usada pelo wplace.live.
 * @type {Array<Object>}
 */
